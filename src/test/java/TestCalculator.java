...
public class TestCalculator {
    ...
    public void testAdd() {
        ...
        assertEquals("add(1,2) = 3 ", 3, calculator.execute());
    }
    ...
    public void testAddWithMult() {
        ...
        assertEquals("add(1, mult(2,3)) = 7", 7, calculator.execute());
    }
    ...
    public void testMultWithDiv() {
        ...
        assertEquals("mult(add(2,2),div(9,3)) = 12", 12, calculator.execute());
    }
    ...
    public void testLetWithAdd() {
        ...
        assertEquals("let(a,5,add(5,5)) = 10", 10, calculator.execute());
    }
    ...
    public void testMultLetWithMultAndAdd() {
        ...
        assertEquals("let(a,5,let(b,mult(a,10),add(b,a))) = 55", 55, calculator.execute());
    }
    ...
    public void testMultLetWithMultAdd() {
        ...
        assertEquals("let(a,let(b,10,add(b,b)),let(b,20,add(a,b))) = 40", 40, calculator.execute());
    }
}
